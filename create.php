...
<body>
	...
	<div id="pick">Give Your Card Deck a Name</div>

	<form class="form" method="post" id="topic-form" action="scripts/create_deck.php" style="width:375px;">
		<input type="text" name="deck" id="deck" placeholder="Enter Deck Name" required min="1" max="50">
